...
| **[`pedestrian-site-visits/README.md`](pedestrian-site-visits/README.md)** | **The first material here that was not retrieved from somebody else.** Two days of phone video, audio, stopwatch laps and stills captured under the bridge on a consumer handset, and a careful account of why none of it is a decibel — with a duty-cycle *ceiling* that survives the uncalibrated chain, a microphone obstruction the analysis flagged before the operator disclosed it, and a null that is honestly reported as no result at all. Q56, Method 38. Renders as [`media.html`](pedestrian-site-visits/media.html). |
...
| **[`pedestrian-site-visits/media.html`](pedestrian-site-visits/media.html)** | **The field media page.** The first material in this repository that was captured rather than retrieved: two days of phone video, audio, stopwatch laps and stills under the bridge, analysed as relative envelopes and times because the recording chain has an unknown gain. Level traces with detected excursions, a duty-cycle threshold sweep, the stopwatch laps, and where every capture stood against every point anyone has ever measured. | The second card, which **refuses to call any of this a decibel** and explains why that refusal is what makes the material admissible. Then the obstruction finding: **a between-clip test flagged the one recording the operator later said he may have covered — before he said it.** |
...
| 38 | **Capture at pedestrian level and extract only what survives an unknown gain** — treat a consumer handset as a recorder of *ratios and times*, never of levels, and report the ceiling rather than the value | 56 | **One afternoon, a phone already owned, executed** | **Executed** — [`pedestrian-site-visits/`](pedestrian-site-visits/README.md). Two days of video, audio, stopwatch laps and stills at 26–162 m from the fitted track axis; **two of the capture points stand closer to the track than three of the four points anyone has ever measured.** Nothing is reported as a decibel. What survives the uncalibrated chain: a **duty-cycle ceiling of 44%** measured from audio alone, which refutes the alternative stopwatch reading (80%) and **does not confirm the accepted one**; an event rate of 56.4/hr against a scheduled 57.7/hr, inside a 95% Poisson interval that runs 13.8–99.0 and is therefore a weak agreement honestly labelled; and a **null on the lawn clip that is not a finding**, because 10.3 s of audio at the measured headway expects 0.16 trains and returns zero by luck 84.8% of the time. **The most useful output was a defect:** a between-clip test flagged the lawn recording as anomalous *before* the operator disclosed that he may have covered the microphone. Against this repository's own protocol the session scores C1 not satisfied, C2 partly and not usefully, C3 partly, C4 and C5 not attempted. |
...
- **Executing any of Methods 0–37** — several cost an email, a form, or an afternoon, and only six have been touched. **Method 21 costs a database query. Method 26 costs leaving a script running for a week. Method 31 — walking a transect outward from the bridge with a meter — costs one afternoon and would establish where the affected zone ends, which nobody has ever determined. Method 28 — measuring how long a person actually stays in the corridor — costs a few hours with a clicker and is now the single blocking unknown for any exposure figure. Method 34 costs one download of a free federal dataset and would break the degeneracy that makes the cohort labels unidentifiable.**
- Answering any of **Q1–Q56** with sourced evidence. **Q42 — whether elevated rapid transit is federally *preempted* from local noise regulation or merely *unregulated* — is the highest-value open question in the programme, and one competent lawyer could settle it in a day.**
